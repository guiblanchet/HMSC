...
RcppExport SEXP mcmcProbitTheory1Sp(arma::mat& Y,
	...
	for (int i = 0; i < niter; i++) {
		...
		// Update latentAuto
		//------------------
		latentAuto = updateLatentAutoTheory1Sp(Yresid, RandomAuto, residVar, paramAuto, wAutoInv, paramLatentAuto, latentAuto, priorParamAutoDistArma, nAuto, nAutoLev, nLatentAuto, nsp, nsite, diagMat);
