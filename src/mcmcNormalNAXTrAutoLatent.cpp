...
#include <Rcpp.h>
#include "mcmcNormalNAXTrAutoLatent.h"

using namespace arma ;
using namespace Rcpp ;

//[[Rcpp::export]]
RcppExport SEXP mcmcNormalNAXTrAutoLatent(arma::mat& Y,
										arma::mat& Ylatent,
										arma::mat& X,
										arma::mat& Tr,
	...
	for (int i = 0; i < niter; i++) {
		...
		Ylatent = sampleYlatentNormal(Y, EstModel, residVar, nsp, nsite);
		...
		paramX = updateParamX(Yresid,X,meansParamX,precX, paramX, nsp, nsite, nparamX);
