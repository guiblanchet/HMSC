...
#include <Rcpp.h>
#include "mcmcNormalAutoLatent.h"

using namespace arma ;
using namespace Rcpp ;

//[[Rcpp::export]]
RcppExport SEXP mcmcNormalAutoLatent(arma::mat& Ylatent,
	...
	return Rcpp::List::create(
				Rcpp::List::create(Rcpp::Named("varNormal", wrap(trans(1/varDistBurn))),
				...
				Rcpp::List::create(Rcpp::Named("varNormal", wrap(trans(1/varDistEst))),
