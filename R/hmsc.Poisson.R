...
##########################################################################################
	...
	#=================================
	Ylatent<-iniYlatent(data,param,family="poisson")
	...
	if(nDataType==2){
		...
		if(all(dataType %in% c("Auto","Random"))){
			...
			result<-mcmcPoissonAutoLatent(Y,
										 Ylatent,
										 AutoCoord,
										 RandomAuto,
										 Random,
	...
	if(nDataType==3){
		...
		if(all(dataType %in% c("X","Phylo","Random"))){
			...
			result<-mcmcPoissonXPhyloLatent(Y,
										   Ylatent,
										   X,
										   Phylo,
										   iPhylo,
		...
		if(all(dataType %in% c("X","Phylo","Auto"))){
			...
			result<-mcmcPoissonXPhyloAuto(Y,
										 Ylatent,
										 X,
										 Phylo,
										 iPhylo,
		...
		if(all(dataType %in% c("X","Auto","Random"))){
			...
			result<-mcmcPoissonXAutoLatent(Y,
										  Ylatent,
										  X,
										  AutoCoord,
										  RandomAuto,
	...
	if(nDataType==4){
		...
		if(all(dataType %in% c("X","Tr","Auto","Random"))){
			...
			result<-mcmcPoissonXTrAutoLatent(Y,
											Ylatent,
											X,
											Tr,
											AutoCoord,
		...
		if(all(dataType %in% c("X","Phylo","Auto","Random"))){
			...
			result<-mcmcPoissonXPhyloAutoLatent(Y,
											   Ylatent,
											   X,
											   Phylo,
											   iPhylo,
		...
		if(all(dataType %in% c("X","Tr","Phylo","Random"))){
			...
			result<-mcmcPoissonXTrPhyloLatent(Y,
											 Ylatent,
											 X,
											 Tr,
											 Phylo,
		...
		if(all(dataType %in% c("X","Tr","Phylo","Auto"))){
			...
			result<-mcmcPoissonXTrPhyloAuto(Y,
										   Ylatent,
										   X,
										   Tr,
										   Phylo,
	...
	if(nDataType==5){
		...
		if(all(dataType %in% c("X","Tr","Phylo","Auto","Random"))){
			...
			result<-mcmcPoissonXTrPhyloAutoLatent(Y,
												 Ylatent,
												 X,
												 Tr,
												 Phylo,
